    ...
    <div className="relative">
      {isPopular && (
        <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
          <div className="bg-gradient-to-r from-amber-500 to-amber-600 text-slate-900 px-6 py-2 rounded-full text-sm font-semibold shadow-lg">
            Most Popular
          </div>
        </div>
      )}
      ...
      <Card 
        className={`cursor-pointer transition-all hover:border-amber-400 bg-slate-800/50 backdrop-blur-sm border-slate-700 ${
          isSelected 
            ? 'border-amber-500 bg-amber-500/10 border-2' 
